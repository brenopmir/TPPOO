...
class ArCondicionadoFrame(customtkinter.CTkScrollableFrame):
    def __init__(self, master, **kwargs):
        ...
        self.header = HeaderDispositivo(master = self, texto = "Ar Condicionado", caminho= "src/icons/arCondicionado.png")

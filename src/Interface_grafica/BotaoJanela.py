...
class BotaoJanela(customtkinter.CTkButton):
    def __init__(self, master,nomeJanela,trancado, abertura):
        ...
        imagem2 = Image.open("src/icons/trancado.png")
        imagem2 = imagem2.resize((25,25))
        icone2 = ImageTk.PhotoImage(imagem2)
        
        self.NomeLabel = customtkinter.CTkLabel(self, text=nomeJanela,
                                                font=("Inika", 20),
                                             text_color="#000000")
        ...
        self.trancadoLabel = customtkinter.CTkLabel(self.container, text = trancado,
